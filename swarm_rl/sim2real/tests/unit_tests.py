...
def compare_torch_to_c_model_outputs_single_drone():
    ...
    torch_model_dir = '/home/resl/newenv/quad-swarm-rl/train_dir/01_single_ToF_see_1111/'
    ...
    c_model_dir = Path('/home/resl/newenv/quad-swarm-rl/train_dir/01_single_ToF_see_1111/attention/')
    ...
    obst_outdata = np.zeros(8).astype(np.float32)

    indata = obs.flatten().detach().numpy()
    outdata = np.zeros(4).astype(np.float32)
    func(indata, obst_indata, obst_outdata, outdata)
    print(torch_model_out, outdata)
...
def compare_torch_to_c_model_multi_drone_attention():
    ...
    c_model_dir = Path('/home/resl/newenv/quad-swarm-rl/train_dir/01_ToFs-new-weight-5-obst_see_1111_q.n.age_1/attention/')
    c_model_path = c_model_dir.joinpath('model_test.c')
    ...
    torch_model_dir = '/home/resl/newenv/quad-swarm-rl/train_dir/01_ToFs-new-weight-5-obst_see_1111_q.n.age_1'
    model = load_sf_model(Path(torch_model_dir), model_type='single')
...
if __name__ == '__main__':
    compare_torch_to_c_model_outputs_single_drone()
